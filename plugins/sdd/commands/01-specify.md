...
## Phase 1: Discovery/Specification Design
...
3. Load `specs/templates/spec-template.md` to understand required sections.
...
7. Report completion with branch name, spec file path, checklist results, and readiness for the next phase `/sdd:01-plan`.
